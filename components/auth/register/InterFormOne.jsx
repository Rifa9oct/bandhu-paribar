                        ...
                        <div className="w-1/2 flex gap-4">
                            ...
                            <div className="w-1/2">
                                ...
                                <select
                                    ...
                                    className={`w-full bg-transparent border-2 text-[#39b54a] rounded px-3 py-2 ${errors.gender ? "border-red-500 focus:outline-red-500" : "border-[#006837] focus:outline-[#006837] mt-2"
                                        }`}
                                >
