    ...
    return (
        <div className="px-[210px] flex justify-between relative bg-[#006837] text-white">
            <div className="relative flex items-center gap-8 justify-between">
                ...
                <button className="border ml-[170px] border-white bg-[#009345] px-3 py-1 rounded-lg">English</button>
            </div>
            ...
            <div className="flex items-center">
                ...
                <div className="flex items-center ml-[120px]">
                    <Link href="/register">
                        <button className="bg-white px-3 py-1 hover:text-[#009345] mr-2 text-[#006837] font-bold rounded-lg">Register</button>
                    </Link>
                    <Link href="/login">
