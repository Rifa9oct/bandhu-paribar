    ...
    return (
        ...
        >
            <div className="absolute flex flex-col pt-[60px] top-0 items-center h-[620px] w-full bg-[#006837] bg-opacity-50">
                <div className="flex flex-col justify-center items-center text-white pb-[70px] md:py-[70px]">
                ...
                <Link href="#" className="relative w-[220px] md:w-[300px] flex mx-auto mt-16">
